...
// Use of __COUNTER__ is suppressed during code analysis in CLion/AppCode
// 2017.2.x and former, because __COUNTER__ is not properly handled by it. This
...
template <typename T> T &opCast(T const &t) { return const_cast<T &>(t); }
...
struct ConfigData {
  ...
  ConfigData()
      : listTests(false), listTags(false), listReporters(false),
        ...
        libIdentify(false), abortAfter(-1), rngSeed(0),
